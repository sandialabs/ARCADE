...
router router_2 interface 0 20.0.2.1/24
router router_2 dhcp 20.0.2.1 range 20.0.2.2 20.0.2.254
router router_2 commit

tap create HMI ip 20.0.1.3/24 nat0

tap create HMI_2 ip 20.0.2.3/24 nat1
...
cc exec ip addr add 20.0.2.15/24 dev ens1
cc filter name=SCADA
cc exec ip addr add 20.0.1.50/24 dev ens1
cc exec ip addr add 20.0.2.50/24 dev ens2
